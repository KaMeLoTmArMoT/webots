...
def compute_reward(state, action, next_state, movement):
    ...
    collision_threshold = 1  # This depends on your specific task
    if min_distance < collision_threshold:
        reward = -150 / min_distance  # Large negative reward for getting too close
    else:
        reward = 150  # No reward or penalty for being a safe distance from obstacles
    ...
    # rotation_penalty = abs(angle_change) * 0.3
